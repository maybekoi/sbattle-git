...
{var}:
    .incbin "SonicBattle.gba", 0x{f"{(raw_addr - rom_start):08x}".upper()}, {size}

""")

print(hex(summed))
with open("new_code.s", "w") as new_rom:
    existing_code = "".join(open("output.s").readlines())
